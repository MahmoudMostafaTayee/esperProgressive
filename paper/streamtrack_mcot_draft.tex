...
We verify tracking accuracy by confirming output parity with the batch baseline~\cite{wang2024overlap}: our system produces identical global identity assignments for the same input data, ensuring that all downstream accuracy metrics (IDF1, HOTA) are preserved by construction (visually affirmed in Figure~\ref{fig:visual_comparison}). 
