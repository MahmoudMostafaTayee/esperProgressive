...
mvn exec:java -Dexec.mainClass="%MAIN_CLASS%" "-Dexec.args=--scene 2 --features_dir %FEATURES_DIR% --camera '0001,0011,0013,0017' --camera_groups '0001,0011;0013,0017'  --turbo --output_dir ./output/scene2" -Dcheckstyle.skip=true
